...
var LIB_DEFAULTS = _.extend(_.cloneDeep(DEFAULTS), {
  taker_gets: {
    currency: 'USD',
    value: '100',
...
var REST_DEFAULTS = _.extend(_.cloneDeep(DEFAULTS), {
  taker_gets: {
    currency: 'USD',
...
module.exports.requestTxOfferCreateResponse = function(request, options) {
  options = options || {};
  var meta = {
    'AffectedNodes': [
      {
  ...
  var synth = {
    'date': 474426920,
    'hash': options.hash || request.hash,
    'inLedger': 11086861,
  ...
  var result = _.extend({
    tx: SerializedObject.from_json(tx).to_hex(),
...
module.exports.RESTOrderResponse = function(options) {
  return JSON.stringify({
    success: true,
    hash: options.hash,
    ledger: 11086861,
...
module.exports.prepareOrderResponse = JSON.stringify({
  success: true,
  tx_blob: '',
  hash: '81FEB61DA6546BDD3D16AF6E043CCA8FC5A58E63F23495EDCC69BBEFE91C18C4',
  order: {
    account: 'r3GgMwvgvP8h4yVWvjH1dPZNvC37TjzBBE',
    taker_gets: {
      currency: 'USD',
  ...
  tx_json: {
    ...
    Sequence: 23,
    SigningPubKey: '02F89EAEC7667B30F33D0687BBA86C3FE2A08CCA40A9186C5BDE2DAA6FA97A37D8',
    TxnSignature: '304402207660BDEF67105CE1EBA9AD35DC7156BAB43FF1D47633199EE257D70B6B9AAFBF02204851869DE713797C7C7FA1ECF89BF6E712AA9E9E8401A58920EEB202788BFE4B'
  }
});

module.exports.prepareOrderCancellationResponse = JSON.stringify({
  success: true,
  tx_blob: '',
  hash: '83595E1C6CBCA095503A22E809A45708698680B5C2E57E0942D628EB682DC4A6',
  order: {
    account: 'r3GgMwvgvP8h4yVWvjH1dPZNvC37TjzBBE',
    fee: '0.000012',
    offer_sequence: 99,
  ...
  tx_json: {
    ...
    Sequence: 23,
    SigningPubKey: '02F89EAEC7667B30F33D0687BBA86C3FE2A08CCA40A9186C5BDE2DAA6FA97A37D8',
    TxnSignature: '304402207660BDEF67105CE1EBA9AD35DC7156BAB43FF1D47633199EE257D70B6B9AAFBF02205C7E6F43DF79C931D34830BAE9EDE0A98D5D3099B78707E73C1FC1A1BCAE8FDF'
 }
});
