...
router.generateIndexPage = function(req, res) {
  ...
  return res.json({
    ...
    endpoints: {
	  ...
	  orders:                 url_base + '/orders/taker-pays/{currency+issuer}/taker-gets/{currency+issuer}'
    }
  });
}
...
router.get('/orders/taker-pays/:taker_pays/taker-gets/:taker_gets', api.orders.get);
