...
router.generateIndexPage = function(req, res) {
  ...
  res.json({
    ...
    endpoints: {
      ...
      orders:                 url_base + '/orders/{taker_pays as currency+issuer}/{taker_gets as currency+issuer}'
    }
  });
};
...
/* Orders */
router.get('/orders/:taker_pays/:taker_gets', api.orders.get);
