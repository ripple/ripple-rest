 ...
 * tx_dst_bals_inc
 */
module.exports.getPayment = function(opts, callback) {
 ...
 *  secret: '...'
 */
module.exports.submitPayment = function(opts, callback) {

  // console.log('submitPayment: ', opts);
...
function isValidAmount(amount) {
  ...
  if (amount.issuer && !rpparser.isRippleAddress(amount.issuer)) {
    return false;
  }
