...
function handleError(error, req, res, next) {
  ...
  if (error.name === InvalidRequestError.name) {
    respond.invalidRequest(res, void(0), err_obj);
  } else if (error.name === NetworkError.name) {
    respond.connectionError(res, void(0), err_obj);
  } else if (error.name === RippledNetworkError.name) {
    respond.connectionError(res, void(0), err_obj);
  ...
  } else if (error.name === ApiError.name) {
